 ...
 */
class A2bizz_Designersoftware_Block_Customer_Design_Items extends A2bizz_Designersoftware_Block_Abstract
{	
	...
	public function getDesignerProductDetailsUrl($params){
		return $this->_model->getDesignerProductDetailsUrl($params);
	}

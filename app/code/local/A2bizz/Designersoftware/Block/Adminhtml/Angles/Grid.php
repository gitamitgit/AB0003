...
class A2bizz_Designersoftware_Block_Adminhtml_Angles_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('anglesGrid');
      $this->setDefaultSort('angles_id');
  ...
  {
      $this->addColumn('angles_id', array(
    ...
    {
        $this->setMassactionIdField('angles_id');
        $this->getMassactionBlock()->setFormFieldName('angles');

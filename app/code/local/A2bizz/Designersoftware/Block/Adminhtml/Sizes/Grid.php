...
class A2bizz_Designersoftware_Block_Adminhtml_Sizes_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	 ...
	 $this->addColumn('filename', array(
          ...
          'sortable'	=>false,
          'width'		=>50,
          'renderer'	=> 'A2bizz_Designersoftware_Block_Adminhtml_Sizes_Renderer_Image',
      ));
      ...
      $this->addColumn('sort_order', array(
          ...
          'width'     => '80px',
          'index'     => 'sort_order',
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Sizes_Renderer_Sort',
      ));

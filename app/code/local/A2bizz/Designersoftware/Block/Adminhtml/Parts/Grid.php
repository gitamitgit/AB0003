...
class A2bizz_Designersoftware_Block_Adminhtml_Parts_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareCollection()
  {
      ...
      foreach($stores as $store):		
		...
		$sql="SELECT title FROM a2bizz_store_parts AS o WHERE o.parts_id = `main_table`.parts_id AND o.store_id=$storeId";

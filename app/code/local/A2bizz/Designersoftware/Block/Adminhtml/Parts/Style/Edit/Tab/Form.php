...
class A2bizz_Designersoftware_Block_Adminhtml_Parts_Style_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  public function getData(){
	  ...
	  if(isset($regData['parts_style_id']) && $regData['parts_style_id']>0):	

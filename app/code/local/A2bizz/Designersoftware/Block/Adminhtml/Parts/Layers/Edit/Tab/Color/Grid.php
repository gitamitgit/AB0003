...
class A2bizz_Designersoftware_Block_Adminhtml_Parts_Layers_Edit_Tab_Color_Grid extends Mage_Adminhtml_Block_Widget_Grid 		
{
	 ...
	 $this->addColumn('colorcode', array(
	  ...
	  $this->addColumn('color_price', array(
		 'header'    		=> Mage::helper('designersoftware')->__('Color Price'),
		  ...
		  'index'     		=> 'colorcode',
		  'width' 			=> 60, 
		  'renderer'  		=> 'A2bizz_Designersoftware_Block_Adminhtml_Color_Renderer_Price',		  
	  ));

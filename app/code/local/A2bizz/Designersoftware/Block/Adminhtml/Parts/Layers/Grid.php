...
class A2bizz_Designersoftware_Block_Adminhtml_Parts_Layers_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('style_design_ids', array(
          ...
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Parts_Layers_Renderer_Style_Design',
      ...
      /*$this->addColumn('filename', array(
           ...
           'filter'		=>false,
           'sortable'	=>false,
           'renderer'	=> 'A2bizz_Designersoftware_Block_Adminhtml_Parts_Layers_Renderer_Leather_Image',
      ));

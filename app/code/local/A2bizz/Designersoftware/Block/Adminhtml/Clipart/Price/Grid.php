...
class A2bizz_Designersoftware_Block_Adminhtml_Clipart_Price_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('clipart_priceGrid');
      $this->setDefaultSort('clipart_price_id');
  ...
  {
      $this->addColumn('clipart_price_id', array(
          'header'    => Mage::helper('designersoftware')->__('ID'),
          'align'     =>'right',
          'width'     => '50px',
          'index'     => 'clipart_price_id',
      ));

      $this->addColumn('width', array(
          'header'    => Mage::helper('designersoftware')->__('Width'),
          'align'     =>'left',
          'index'     => 'width',
      ));
      
      $this->addColumn('height', array(
          'header'    => Mage::helper('designersoftware')->__('Height'),
          'align'     =>'left',
          'index'     => 'height',
      ));

	  
      $this->addColumn('width_price', array(
			'header'    => Mage::helper('designersoftware')->__('Width Price'),
			'width'     => '150px',
			'index'     => 'width_price',
      ));
      
      $this->addColumn('height_price', array(
			'header'    => Mage::helper('designersoftware')->__('Height Price'),
			'width'     => '150px',
			'index'     => 'height_price',
      ));
	  ...
	  /*$this->addColumn('sort_order', array(
          ...
          'width'     => '80px',
          'index'     => 'sort_order',
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Clipart_Price_Renderer_Sort',
      ));*/
    ...
    {
        $this->setMassactionIdField('clipart_price_id');
        $this->getMassactionBlock()->setFormFieldName('clipart_price');

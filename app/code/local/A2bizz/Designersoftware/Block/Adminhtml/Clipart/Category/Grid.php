...
class A2bizz_Designersoftware_Block_Adminhtml_Clipart_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('clipart_categoryGrid');
      $this->setDefaultSort('clipart_category_id');
  ...
  protected function _prepareColumns()
  {
	  ...
	  */
	  ...
	  $this->addColumn('sort_order', array(
          ...
          'width'     => '80px',
          'index'     => 'sort_order',
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Clipart_Category_Renderer_Sort',
      ));
    ...
    {
        $this->setMassactionIdField('clipart_category_id');
        $this->getMassactionBlock()->setFormFieldName('clipart_category');

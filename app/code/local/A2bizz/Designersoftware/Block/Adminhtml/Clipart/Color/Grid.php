...
class A2bizz_Designersoftware_Block_Adminhtml_Clipart_Color_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('clipart_colorGrid');
      $this->setDefaultSort('clipart_color_id');
  ...
  {
      $collection = Mage::getModel('designersoftware/clipart_color')->getCollection();

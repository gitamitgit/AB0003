...
class A2bizz_Designersoftware_Block_Adminhtml_Clipart_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('clipart_category_id', array(
	   ...
	   $this->addColumn('filename', array(
          ...
          'sortable'	=>false,
          'width'		=>50,
          'renderer'	=> 'A2bizz_Designersoftware_Block_Adminhtml_Clipart_Renderer_Image',
      ));
      ...
      $this->addColumn('print', array(
          'header'    => Mage::helper('designersoftware')->__('Print'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'print',
          'type'      => 'options',

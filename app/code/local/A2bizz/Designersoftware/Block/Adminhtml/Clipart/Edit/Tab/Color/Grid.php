...
class A2bizz_Designersoftware_Block_Adminhtml_Clipart_Edit_Tab_Color_Grid extends Mage_Adminhtml_Block_Widget_Grid 		
{
	public function _construct()
	{	
		parent::_construct();		
		$this->setId('clipart_colorGrid');
	...
	protected function _prepareColumns()
	{
	 ...
	 $this->addColumn('colorcode', array(
		  ...
		  'align'     =>'left',
		  'index'     => 'colorcode',
		  'renderer'  =>'A2bizz_Designersoftware_Block_Adminhtml_Color_Renderer_Color',
	  ));	
    ...
    public function getSelectedColors()
    {
        ...
        if($tm_id >0 ) {			
            $clipartCollection = Mage::getModel('designersoftware/clipart')->getCollection()->addFieldToFilter('clipart_id',$tm_id)->addFieldToFilter('status',1)->getFirstItem();	            
            if(count($clipartCollection	)>0):										
				$color = unserialize($clipartCollection->getColorIds());   					
			endif;
        }  	

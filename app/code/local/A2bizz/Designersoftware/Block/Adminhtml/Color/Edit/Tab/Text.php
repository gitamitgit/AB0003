...
class A2bizz_Designersoftware_Block_Adminhtml_Color_Edit_Tab_Text extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('color_form', array('legend'=>Mage::helper('designersoftware')->__('Text Information')));
	  
	  
	  $fieldset->addField('text_price', 'text', array(
          'label'     => Mage::helper('designersoftware')->__('Text Color Price'),
      ...
      /*$fieldset->addField('title', 'text', array(
          'label'     => Mage::helper('color')->__('Color Title'),
          'class'     => 'required-entry',
          'required'  => true,
          'name'      => 'title',
          'disabled'  => 'disabled',

...
class A2bizz_Designersoftware_Block_Adminhtml_Color_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
     ...
     $this->addColumn('colorcode', array(
      ...
      $this->addColumn('texture_id', array(
          'header'    => Mage::helper('designersoftware')->__('Texture'),
          'align'     => 'left',
          'width'     => '10px',
          'index'     => 'texture_id',
          'renderer'=>'A2bizz_Designersoftware_Block_Adminhtml_Color_Renderer_Image',
      ));

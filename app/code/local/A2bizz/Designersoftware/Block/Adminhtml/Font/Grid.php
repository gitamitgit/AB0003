...
class A2bizz_Designersoftware_Block_Adminhtml_Font_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('ttf_image_name', array(
          ...
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Font_Renderer_Font'
       ));

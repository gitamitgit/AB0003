<?php
class A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $paramsEdit = Mage::helper('designersoftware/product')->setParams($data['designersoftware_id']);            

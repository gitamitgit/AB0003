<?php
class A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_Image extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {

    public function render(Varien_Object $row) {
        $data = $row->getData();
        
        $commPath = 'media' . DS . 'a2bizz' . DS . 'designs' . DS . $data['style_design_code']. DS . 'original' . DS;

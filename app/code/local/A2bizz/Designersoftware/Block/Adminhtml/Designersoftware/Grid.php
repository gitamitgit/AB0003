...
class A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('customer_id', array(
          ...
          'align'     =>'left',
          'index'     => 'customer_id',
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_Customer',
	  ...
	  $this->addColumn('filename', array(
          ...
          'width'     => '50px',
          'filter'    => false,
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_Image',
      ));
      ...
      $this->addColumn('sort_order', array(
          ...
          'width'     => '80px',
          'index'     => 'sort_order',
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_Sort',
      ));
	  ...
	  */
      ...
      $this->addColumn('content', array(
          ...
          'filter'    => false,     
          'width'     => '100px',
          'renderer'  => 'A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_drawarea',
      )); 
        ...
        $this->addColumn('action',
            array(
                ...
                'index'     => 'stores',
                'is_system' => true,
                'renderer'	=> 'A2bizz_Designersoftware_Block_Adminhtml_Designersoftware_Renderer_Action',
        ));       

<?php
class A2bizz_Designersoftware_CustomerController extends Mage_Core_Controller_Front_Action
{
   /**
    ...
    public function designAction(){
		...
		$this->loadLayout();		
		$this->getLayout()->getBlock('head')->setTitle($this->__('My Designs')); 		    
		$this->renderLayout();

...
class A2bizz_Designersoftware_Adminhtml_Parts_StyleController extends Mage_Adminhtml_Controller_action
{
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$storeData['parts_style_id'] = $model->getId();					
				Mage::helper('designersoftware/store_parts_style')->setDataById($storeData);	

...
class A2bizz_Designersoftware_Adminhtml_PartsController extends Mage_Adminhtml_Controller_action
{
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$storeData['parts_id'] = $model->getId();	
				Mage::helper('designersoftware/store_parts')->setDataById($storeData);	

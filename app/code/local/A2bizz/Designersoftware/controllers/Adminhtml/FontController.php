...
class A2bizz_Designersoftware_Adminhtml_FontController extends Mage_Adminhtml_Controller_action
{
        ...
        public function saveTtfFiles($filename){
            ...
            if(isset($_FILES[$filename]['name']) && $_FILES[$filename]['name'] != '') {
                try {	
                        ...
                        $resultObj = Mage::helper('designersoftware/font_ttf')->generateFontImage($pathTTF . $_FILES[$filename]['name'], $_FILES[$filename]['name'], $pathTTFImg);
                        $imageName[$filename] = $_FILES[$filename]['name'];

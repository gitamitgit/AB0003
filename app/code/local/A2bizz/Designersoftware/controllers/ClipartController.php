<?php
class A2bizz_Designersoftware_ClipartController extends Mage_Core_Controller_Front_Action
{
    ...
    {   	
		$JSON = Mage::helper('designersoftware/clipart_price_json')->load($this->getRequest()->getParams());		
		$this->getResponse()->setBody(Mage::helper('core')->jsonEncode($JSON));
    }   

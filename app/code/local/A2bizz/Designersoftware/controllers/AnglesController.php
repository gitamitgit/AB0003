<?php
class A2bizz_Designersoftware_AnglesController extends Mage_Core_Controller_Front_Action
{
	protected function _initDesignerSoftware(){							
		$allowed_hosts = array('10.0.4.4','124.124.87.46','198.154.244.65','jbcases.com','localhost','127.0.0.1');
    ...
    {
		Mage::getModel('sitemap/resource_catalog_product')->getTest();
		$this->loadLayout();
		$this->renderLayout();
	}    
}

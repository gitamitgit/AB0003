...
class A2bizz_Designersoftware_Model_Designersoftware extends A2bizz_Designersoftware_Model_Abstract
{
	...
	public function getCustomerDesignASCCollection(){
		
		$customerId = Mage::helper('designersoftware/customer')->getCurrentCustomerId();
		$collection = $this->getDesignersoftwareCollection()
							->addFieldToFilter('customer_id',$customerId)
							->setOrder('designersoftware_id','ASC');
							//->addFieldToFilter('remove_status',0);

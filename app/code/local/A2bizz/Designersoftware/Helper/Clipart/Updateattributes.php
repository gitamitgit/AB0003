...
class A2bizz_Designersoftware_Helper_Clipart_Updateattributes extends Mage_Core_Helper_Abstract
{	
	public function updateAttributes($dataClipart){
		...
		foreach($clipartIdsArray as $clipartId){
			...
			if(!empty($dataClipart['print'])|| $dataClipart['print']==0){$data['print']=$dataClipart['print'];$status=1;}

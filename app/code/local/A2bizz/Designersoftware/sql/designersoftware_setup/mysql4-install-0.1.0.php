...
--
-- Dumping data for table `a2bizz_angles`
--

INSERT INTO {$this->getTable('a2bizz_angles')}  (`title`, `filename`, `content`, `status`, `created_time`, `update_time`) VALUES
('000', '', '', 1, now(), now()),
('045', '', '', 1, now(), now()),
('090', '', '', 1, now(), now()),
('135', '', '', 1, now(), now()),
...
--
-- Dumping data for table `a2bizz_color`
--

INSERT INTO {$this->getTable('a2bizz_color')} (`color_id`, `title`, `filename`, `content`, `colorcode`, `clip_price`, `text_price`, `clip_status`, `text_status`, `status`, `created_time`, `update_time`) VALUES
...
--
-- Creating Structure for table `a2bizz_parts_layers_texture`
--

-- DROP TABLE IF EXISTS {$this->getTable('a2bizz_parts_layers_texture')};
CREATE TABLE {$this->getTable('a2bizz_parts_layers_texture')} (
...
-- DROP TABLE IF EXISTS {$this->getTable('a2bizz_parts_style')};
CREATE TABLE {$this->getTable('a2bizz_parts_style')} (
...
--
-- Creating Structure for table `a2bizz_style`
--

-- DROP TABLE IF EXISTS {$this->getTable('a2bizz_style')};
CREATE TABLE {$this->getTable('a2bizz_style')} (
...
--
-- Creating Structure for table `a2bizz_text`
--

-- DROP TABLE IF EXISTS {$this->getTable('a2bizz_text')};
CREATE TABLE {$this->getTable('a2bizz_text')} (

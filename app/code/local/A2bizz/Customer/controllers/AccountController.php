...
class A2bizz_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function loginPostAction()
    {
		...
		//echo 'local<pre>';print_r($session);exit;
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    ...
                    if ($session->getCustomer()->getIsJustConfirmed()) {
						echo 'if if Login Post Action '; exit;
    ...
    {
		//================ Add Designs to Customer Account from Session (WISHLIST Converted Save Design)=================START===================
		
		Mage::helper('designersoftware/customer')->addProductToWishlist();
		
		//================ Add Designs to Customer Account from Session (WISHLIST Converted Save Design)==================END==================
    ...
    public function createPostAction()
    {
        ...
        try {
            ...
            if (empty($errors)) {
                ...
                //========================== Add Designs to Customer Account from Session =================START===================
		
				//Mage::helper('designersoftware/customer')->addProductToWishlist();
				
				//========================== Add Designs to Customer Account from Session ==================END==================
                return;
            } else {

...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="779">
	<tr>
      ...
      <?php if ($execVal==1) {?>  <td valign="top">
        ...
        <td valign="top">
        	<table>
            	<tr>
                    ...
                    <?php } else if($imgVerCheck==0) {?>
                    <td><b><span style="color:#FF0000">Well done,</span> Imagemagick is <span style="color:#FF0000">installed</span> on your server.</b> But the current version is <?php echo $currentVersion ?> which is not compatible with our software. Please instal <b>Imagemagick 6.6.0 (or greater)</b> to work no-refresh's software without any problem.</td>
                    <?php } else {?>
                    <td><b><span style="color:#00CC00;">Congrats!</span> Imagemagick is <span style="color:#00CC00">installed</span> on your server</b>. Installed version of Imagemagick on your server is <?php echo $currentVersion?> And Execution path is <?php echo $imgPath?></td>
                    <?php } ?>
                </tr>
            </table>	
        </td>
